...
if __name__ == '__main__':
    config_path = 'E:\jupyter\chinese_L-12_H-768_A-12/albert_base/albert_config.json'
    checkpoint_path = 'E:\jupyter\chinese_L-12_H-768_A-12/albert_base/model.ckpt-best'
    num_labels = 39
    lstm_units = 128
    drop_rate = 0.3
    learning_rate = 5e-5
